...
- **[Recoup / VandyLoop](https://github.com/Orimia/recoup)**: founded a verified recycle-to-reward system for universities and led it from concept through team formation, product and system design, stakeholder alignment, and a working software prototype. The platform includes a verified-event ledger, rewards engine, operator analytics, anti-fraud controls, a signed hardware-event API, and ESP32 firmware. A Vanderbilt physical pilot is in development, with the first bins now being built. **[Live software prototype](https://vandyloop.vercel.app)**
- **Curevo Health**: shipped production systems for a Stockholm digital-health startup, including **8+ production analytics dashboards** that unified Stripe, Meta, Google, and PostHog data for real-time operating decisions. Also implemented and tested BankID authentication for live mobile and desktop users. Code is private.
...
[LinkedIn](https://www.linkedin.com/in/haonanwang7) · haonan.wang@vanderbilt.edu
